...
export APOLLO_HTTP_URI="https://regtest.staging.mxbank.app/graphql"
export APOLLO_WEBSOCKET_URI="wss://regtest.staging.mxbank.app/subscriptions"
export GATEWAY_URL="https://regtest.staging.mxbank.app"
export GATEWAY_HOST="regtest.staging.mxbank.app"
export GATEWAY_PORT=""
