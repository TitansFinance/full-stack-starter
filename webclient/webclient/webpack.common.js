...
const plugins = [
  ...
  new webpack.DefinePlugin({
    ...
    'process.env.FRONTEND_GATEWAY_URL': JSON.stringify(process.env.FRONTEND_GATEWAY_URL || 'http://127.0.0.1:3000'),
    'process.env.FRONTEND_GATEWAY_HOST': JSON.stringify(process.env.FRONTEND_GATEWAY_HOST || '127.0.0.1'),
    'process.env.FRONTEND_GATEWAY_PORT': JSON.stringify(process.env.FRONTEND_GATEWAY_PORT || '3000'),
